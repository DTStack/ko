 ...
 */
 ...
 const jsxUtil = require('../utils/jsx');
 const reportC = require('../utils/report');
 const isParenthesized = require('../utils/ast').isParenthesized;
 ...
 module.exports = {
   meta: {
     docs: {
       ...
       recommended: false,
       url: 'https://github.com/DTStack/Code-Style-Guide/blob/master/react/README.md#parentheses',
     },
     fixable: 'code',
